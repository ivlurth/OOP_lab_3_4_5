...
namespace Autopark {
	...
	/// <summary>
	/// Сводка для PickupEntryForm
	/// </summary>
	public ref class PickupEntryForm : public System::Windows::Forms::Form
	{
	public:
		PickupEntryForm(void)
		{
			InitializeComponent();
			...
			if (FILL_FORM == 2) {
				...
				textBox9->Text = getLocalString(weight);
			}
		}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Click += gcnew System::EventHandler(this, &PickupEntryForm::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &PickupEntryForm::button1_Click);
			// 
			// textBox7
			// 
			...
			this->label8->Text = L"Масса груза:";
			// 
			// label7
			// 
			...
			this->ClientSize = System::Drawing::Size(359, 343);
			...
			this->Name = L"PickupEntryForm";
			this->Text = L"PickupEntryForm";
