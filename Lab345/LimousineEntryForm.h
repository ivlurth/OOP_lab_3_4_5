...
namespace Autopark {
	...
	/// <summary>
	/// Сводка для LimousineEntryForm
	/// </summary>
	public ref class LimousineEntryForm : public System::Windows::Forms::Form
	{
	public:
		LimousineEntryForm(void)
		{
			InitializeComponent();
			...
			if (FILL_FORM == 1) {
				...
				textBox9->Text = getLocalString(length);
			}
		}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(191, 315);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(75, 23);
			this->button2->TabIndex = 37;
			this->button2->Text = L"Отмена";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &LimousineEntryForm::button2_Click);
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(86, 315);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(75, 23);
			this->button1->TabIndex = 36;
			this->button1->Text = L"ОК";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &LimousineEntryForm::button1_Click);
			// 
			// textBox7
			// 
			...
			this->label8->Text = L"Длина лимузина:";
			// 
			// label7
			// 
			...
			// textBox9
			// 
			this->textBox9->Location = System::Drawing::Point(170, 266);
			...
			this->ClientSize = System::Drawing::Size(365, 350);
			...
			this->Name = L"LimousineEntryForm";
			this->Text = L"LimousineEntryForm";
