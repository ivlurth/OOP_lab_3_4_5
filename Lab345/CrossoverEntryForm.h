...
namespace Autopark {
	...
	/// <summary>
	/// Сводка для CrossoverEntryForm
	/// </summary>
	public ref class CrossoverEntryForm : public System::Windows::Forms::Form
	{
	public:
		CrossoverEntryForm(void)
		{
			InitializeComponent();
			...
			if (FILL_FORM == 0) {
				...
				OutputDebugStringA("\n!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
				OutputDebugStringA(lock2.c_str());
				OutputDebugStringA("123!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n");
				textBox7->Text = getLocalString(passengerCapacity);
				if (hasAllDrive) {
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label7->Text = L"Кол-во пассажиров:";
			// 
			// label8
			// 
			...
			this->label8->Size = System::Drawing::Size(199, 17);
			this->label8->TabIndex = 7;
			this->label8->Text = L"Постоянный полный привод:";
			// 
			// textBox1
			// 
			...
			this->checkBox1->CheckedChanged += gcnew System::EventHandler(this, &CrossoverEntryForm::checkBox1_CheckedChanged);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &CrossoverEntryForm::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &CrossoverEntryForm::button2_Click);
			// 
			// textBox8
			// 
			...
			this->ClientSize = System::Drawing::Size(362, 388);
			...
			this->Name = L"CrossoverEntryForm";
			this->Text = L"CrossoverEntryForm";
